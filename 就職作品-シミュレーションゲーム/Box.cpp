...
void Box::Draw() {
	...
	if (m_ishit) {
		devcontext->PSSetShader(m_pPixelShader[1], nullptr, 0);			// ピクセルシェーダーをセット
	}
	else
	{
		devcontext->PSSetShader(m_pPixelShader[0], nullptr, 0);			// ピクセルシェーダーをセット
	}
