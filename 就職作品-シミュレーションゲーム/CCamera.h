...
public:
	...
	//FPSカメラ
	void FPSCamera(XMFLOAT4X4 mtx);

	//TPSカメラ
	void TPSCamera(XMFLOAT4X4 mtx);

	//遅れて移動するカメラ(TPS)
	void DelayTPSCamera(XMFLOAT4X4 mtx);

	//固定注視カメラ
	void FixedCamera(XMFLOAT3 lookat);
	...
	XMFLOAT3 Lerp(XMFLOAT3 from, XMFLOAT3 to, double t);
